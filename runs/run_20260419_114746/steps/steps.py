...
async def fill_credentials(login_page, username: str, password: str) -> None:
    """
    ...
    username_locator = await resolve_locator(page, 'username')
    password_locator = await resolve_locator(page, 'password')
...
async def click_login_button(login_page) -> None:
    """
    ...
    button_locator = await resolve_locator(page, 'login_button')
...
async def assert_error_message(login_page, expected_error: str) -> None:
    """
...
async def verify_products_page(page) -> ProductsPage:
    """
